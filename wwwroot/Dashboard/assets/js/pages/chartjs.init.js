        ...
        if ($("#donut-chart").length) {
            ...
            var pieChart = new Chart(pieChartCanvas, {
                ...
                data: {
                    datasets: [{
                        data: [21, 16, 48, 31],
                        backgroundColor: ['#0d550c','#7c8a96','#11c46e','#eeb148'],
                        borderColor: ['#0d550c','#7c8a96','#11c46e','#eeb148']
                    }],
                ...
                data: {
                    datasets: [
                        ...
                        {   
                            ...
                            borderColor: "#0d550c",
                            borderWidth: 1,
                            pointBackgroundColor: "#0d550c",
                            pointBorderColor: "#fff",
                            pointHoverBackgroundColor: "#fff",
                            pointHoverBorderColor: "#0d550c",
